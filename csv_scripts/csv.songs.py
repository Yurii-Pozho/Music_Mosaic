...
with open(r'C:\Users\user\Desktop\music\data\songs.jl', encoding='utf8') as in_file, \
		open(r"C:\Users\user\Desktop\music\csv_scripts\songs.csv", 'a', encoding='utf8') as out_file:
